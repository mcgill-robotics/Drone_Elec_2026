...
/* Definitions for GimbalUpdate */
osThreadId_t GimbalUpdateHandle;
const osThreadAttr_t GimbalUpdate_attributes = {
  .name = "GimbalUpdate",
...
/* Definitions for DJIO3 */
osThreadId_t DJIO3Handle;
const osThreadAttr_t DJIO3_attributes = {
  .name = "DJIO3",
...
void StartGimbalUpdate(void *argument);
void StartErrorLED(void *argument);
void StartDJIO3(void *argument);
...
int main(void)
{
  ...
  /* creation of GimbalUpdate */
  GimbalUpdateHandle = osThreadNew(StartGimbalUpdate, NULL, &GimbalUpdate_attributes);

  /* creation of ErrorLED */
  ErrorLEDHandle = osThreadNew(StartErrorLED, NULL, &ErrorLED_attributes);

  /* creation of DJIO3 */
  DJIO3Handle = osThreadNew(StartDJIO3, NULL, &DJIO3_attributes);
...
/* USER CODE BEGIN Header_StartGimbalUpdate */
/**
* @brief Function implementing the GimbalUpdate thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartGimbalUpdate */
void StartGimbalUpdate(void *argument)
{
  /* USER CODE BEGIN StartGimbalUpdate */
  (void) argument;
  osDelay(introduce_jitter(1000));
  uint32_t ticks = osKernelGetTickCount();
  ...
  /* USER CODE END StartGimbalUpdate */
}
...
/* USER CODE BEGIN Header_StartDJIO3 */
/**
* @brief Function implementing the DJIO3 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartDJIO3 */
void StartDJIO3(void *argument)
{
  /* USER CODE BEGIN StartDJIO3 */
  DJI_O3_Handle_t o3;
  osDelay(5000);
  DJI_O3_Init(&o3, &huart1);
  /* Infinite loop */
  for(;;)
  {
    DJI_O3_Update(&o3, arm_status);
    osDelay(500);
  }
  /* USER CODE END StartDJIO3 */
}
